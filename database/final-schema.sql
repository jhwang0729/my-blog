-- Final Personal Web Application Database Schema
...
CREATE TABLE IF NOT EXISTS work_experiences (
  ...
  employment_type TEXT, -- 'full-time', 'part-time', 'internship', 'volunteer', 'academic'
...
CREATE TABLE IF NOT EXISTS skills (
  ...
  user_id UUID REFERENCES profiles(id) ON DELETE CASCADE NOT NULL,
  name TEXT NOT NULL,
  category TEXT, -- 'programming', 'languages', 'tools', 'frameworks', etc.
...
-- Create certifications table (optional - can be omitted if no certifications)
...
CREATE POLICY "Visible certifications are viewable by everyone"
